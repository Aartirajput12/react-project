...
{/* RESPONSIVE CSS */}
<style> {` .gp8, .grp9 { display: flex; justify-content: space-around; gap: 20px; margin-top: 30px; flex-wrap: wrap; } 
 .gp8 .card, .grp9 .card { width: 25rem; } .product-img { width: 100%; height: 400px; object-fit: cover; }
  ...
  { .gp8, .grp9 { display: flex !important; flex-direction: column !important; align-items: center !important; justify-content: center !important; gap: 20px !important; padding: 0 15px; } 
   .gp8 .card, .grp9 .card { width: 100% !important; max-width: 400px; } 
